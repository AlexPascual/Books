...
import gui.PurchaseConfirmation;
  ...
  public void action() {
    ...
    if(msg != null) {
      ...
      if(price != null) {
        ...
        String message = title + " sold to agent " + msg.getSender().getName();
        System.out.println(message);
        // Deploy alert dialog
        PurchaseConfirmation confirmation = new PurchaseConfirmation(message);
      } else {
